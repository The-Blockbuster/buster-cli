...
module.exports = {
    command: 'repl',
    desc: 'launch interactive Node.js shell with BUSTER connection available to use.\n'+
           'The repl\'s initial context contains `busterAPI`, `buster` and `account`\n'+
           ...
           'USAGE:\n' +
           '    buster repl --accountId bob\n    > console.log(account)\n    > .load script.js\n\n' +
           '    buster repl -s ./scripts/delpoyContracts.js\n' +
           '    buster repl -s ./scripts/run.js -- test.buster bob.test.buster\n' +
           '    buster repl -s ./script.ts \n',
    builder: (yargs) => yargs
        .option('script', {
