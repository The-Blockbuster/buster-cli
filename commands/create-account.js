...
const createAccountCommandDeprecated = {
    ...
    handler: exitOnError(async (options) => {
        console.log('buster create_account is deprecated and will be removed in version 0.26.0. Please use buster create-account.');
...
async function createAccount(options) {
    ...
    if (splitAccount.length === 1) {
        ...
        // Subaccounts (short.alice.buster, even.more.bob.test, and eventually peter.potato)
        ...
        // See: https://github.com/buster/buster-cli/issues/387
    ...
    try {
        ...
        if (error.type === 'RetriesExceeded') {
            ...
            console.warn(`buster state ${options.accountId}`);
