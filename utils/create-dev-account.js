...
module.exports = async function createDevAccountIfNeeded({ near, keyStore, networkId, init, projectKeyDirectory, masterAccount }) {
    // TODO: once examples and create-buster-app use the dev-account.env file, we can remove the creation of dev-account
    // https://github.com/buster/buster-cli/issues/287
