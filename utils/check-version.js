...
/**
    check the current version of BUSTER CLI against latest as published on npm
 */
module.exports = async function checkVersion() {
    ...
    if (
        ...
        const message = chalk`BUSTER CLI has a ${update} available {dim ${current}} → {green ${latest}}
